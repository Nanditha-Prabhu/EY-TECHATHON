...
const navigation = [
  ...
  { name: "Shop", href: "./Shop.jsx", current: false},
...
export default function Navbar() {
  return (
    <Disclosure
      as="nav"
      className="bg-gray-800 overflow-hidden sticky top-0 z-50 drop-shadow-[0_4px_3px_rgba(255,255,255,0.25)] "
    >
      {({ open }) => (
        <>
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-row flex-shrink-0 items-center">
                  <img
                    ...
                    alt="Your Company"
                  />
                  <h1 className=" ml-4 text-xl text-slate-100">Stylify-AI</h1>
                </div>
                  ...
                  <div className="flex space-x-4">
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="text"
                        id="Search"
                        placeholder="Farm Fresh fruits"
                        className="w-full p-3 rounded-md border-gray-200 py-2.5 pe-10 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-white sm:text-sm"
                      />
                    ...
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <Menu.Item>
                        {({ active }) => (
                          ...
                          >
                            New collections in Mens T-Shirts
                          </a>
                        )}
                      </Menu.Item>
                    </Menu.Items>
