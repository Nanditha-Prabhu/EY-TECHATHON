...
//   return(
//     <>
//     <Link to={ "https://1d76-2405-204-539e-9336-4dd7-7c18-17f1-96f3.ngrok-free.app/"}/></>
//   )
// }
...
//   return(
//     <>
//     <Link to={{ pathname: "https://personalized-shopping-assistant.streamlit.app/"}}/></>
//   )
// }
...
export default function Navbar() {
  return (
    <Disclosure
      as="nav"
      className="bg-gray-800  sticky top-0 z-50 drop-shadow-[0_4px_3px_rgba(255,255,255,0.25)] "
    >
      {({ open }) => (
        <>
